...
export type CountryList = { __typename: 'Query', countries?: Types.Maybe<Array<Types.Maybe<{ __typename: 'Country', _id?: Types.Maybe<string>, name: string, alpha2Code: string, capital: string, population: number, flag?: Types.Maybe<{ __typename: 'Flag', _id?: Types.Maybe<string>, emoji: string }> }>>> };
